// PostFilter_Thermal.cpp : Defines the entry point for the console application.
//
...
#include <SigmaUtil/SulPostFilterThermal.h>
...
osg::Node* createScene( osgViewer::Viewer* viewer )
{
	...
	CSulPostFilterThermal* postfilter = new CSulPostFilterThermal;
