...
#ifndef __SULCLOUDSTEXTURE_H__
#define __SULCLOUDSTEXTURE_H__
...
class SUL_EXPORT CSulCloudsTexture : public osg::Referenced
{
public:
				CSulCloudsTexture( CSulCloudPlane* pCloudPlane=0 );
